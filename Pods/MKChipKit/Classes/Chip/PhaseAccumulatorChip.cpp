...
void PhaseAccumulatorChip::resetInput()
{
    ...
    // TODO: possibly remove powf and log2f for efficiency, division is slow
    mPhaseIncrementFloat = 1.0*powf(2, (mPhaseIncrementFloat/((float)(1<<nbits)-1)*log2f(srate/2))); //16 bit to keep it at full accuracy
    mPhaseIncrementFloat *= (float)((1<<16)-1)/srate; // TODO precompute division as multiplication?
